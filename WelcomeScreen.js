...
import {Text, View, StyleSheet, TouchableOpacity, TextInput, Modal, KeyboardAvoidingView, Alert} from 'react-native';
    ...
    render() {
        return (
            <View style = {styles.container}>
                ...
                {/* <View style={styles.profileContainer}> <SantaAnimation/> <Text style={styles.title}>Book Santa</Text> </View> */}
                {this.showModal()}
